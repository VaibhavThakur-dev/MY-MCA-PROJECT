...
<div style="margin-top:5px">
    <img src="image/complaint3.jpg" style="width:100%;height:150px;margin-top:0px;border-radius:2px;box-shadow:0px 0px 1px black" />
</div>
...
<p style="margin-left:4%;margin-right:4%">
      <img src="image/complaints.jpg" style="height:120px;width:180px;"></p>
      <p style="margin-left:46%;margin-top:-100px;margin-right:4%;  font-weight: bold;">Your Project Title or Your Company Name.<br>HIET College NH-24 Ghaziabad <br>
                              Uttar Pradesh - 201001 <br></p><br>
           
      <br><br> <p style="margin-left:6%;margin-right:8%;">
    <b> For Enquiry</b> : +91-9990046906<br><br>
     <b>Office No</b> : +91-9990046906<br/><br/>
     <b>For Query :</b> +91-9990046906<br><br>
     <b> For Advertisement : </b>e,mandi123@gmail.com<br><br>
     <b>  Email :</b> emandi123@gmail.com<br><br>
     <b>  Website:</b><a href="#" target="_blank" > www.emandi.com </a>   
    </p>
